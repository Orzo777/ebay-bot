...
EXTRA_DENY = ["folie", "schutz", "tasche", "huelle", "displayschutz", "netzteil", "ladegeraet", "ladekabel",
              ...
              "gebraucht", "used", "refurbished", "generalueberholt", "b-ware", "bware", "vorfuehrer", "open", "box only"]
...
for q, must, mp in SKUS:
    ...
    json.dump(out, open(SP + "/tech_probe.json", "w", encoding="utf-8"), ensure_ascii=False)
